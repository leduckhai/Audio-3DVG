...
def get_parser():
    parser = argparse.ArgumentParser(description='Audio-3DVG')
    parser.add_argument('--gpu', type=str, default='0', help='GPU idx')
    parser.add_argument('--config', type=str, default='config/audio-3dvg.yaml', help='path to config file')
...
# path
CONF.PATH = EasyDict()
CONF.PATH.BASE = "/home/duccd/Desktop/audio-3dvg/" 
...
CONF.exp_path = os.path.join(CONF.PATH.BASE, 'checkpoints')
CONF.PATH.OUTPUT = os.path.join(CONF.PATH.BASE, 'checkpoints')
